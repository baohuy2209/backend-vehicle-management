...
export interface ApiLinkedBankAccountLinkedBankAccount
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    statusaccount: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    floorlocation: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    statuslocation: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiParkingCheckoutParkingCheckout
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    actualexittime: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::parking-checkout.parking-checkout'
    > &
      Schema.Attribute.Private;
...
export interface ApiParkingRegistrationDetailParkingRegistrationDetail
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::parking-registration-detail.parking-registration-detail'
    > &
      Schema.Attribute.Private;
...
export interface ApiParkingRegistrationParkingRegistration
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    parking_checkout: Schema.Attribute.Relation<
      'oneToOne',
      'api::parking-checkout.parking-checkout'
    >;
    parking_registration_details: Schema.Attribute.Relation<
      'oneToMany',
      'api::parking-registration-detail.parking-registration-detail'
    >;
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currenttime: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::payment.payment'
    ...
    parking_checkout: Schema.Attribute.Relation<
      ...
      'api::parking-checkout.parking-checkout'
    >;
    pcid: Schema.Attribute.String;
    phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    statuspayment: Schema.Attribute.String;
    totalpayment: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVehicleInfoVehicleInfo extends Struct.CollectionTypeSchema {
  collectionName: 'vehicle_infos';
  info: {
    displayName: 'VehicleInfo';
    pluralName: 'vehicle-infos';
    singularName: 'vehicle-info';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::parking-registration-detail.parking-registration-detail': ApiParkingRegistrationDetailParkingRegistrationDetail;
      'api::parking-registration.parking-registration': ApiParkingRegistrationParkingRegistration;
      'api::payment.payment': ApiPaymentPayment;
      'api::vehicle-info.vehicle-info': ApiVehicleInfoVehicleInfo;
